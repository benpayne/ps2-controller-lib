...
//
// Provides metastability protection for asynchronous inputs
// by using a 2-flip-flop synchronizer followed by debounce logic.
//
// The debounce logic requires the input to be stable for DEBOUNCE_CYCLES
// system clock cycles before the output changes.
//
...
module debounce #(
    ...
    // Using DEBOUNCE_CYCLES = 128 means counter[6:0] is used
